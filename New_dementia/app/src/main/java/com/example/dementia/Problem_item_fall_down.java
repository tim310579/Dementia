...
public class Problem_item_fall_down extends AppCompatActivity {
    private TextView tv_show_number, tv_show_name, tv_show_time;
    private TextView tv_problem_item_fall_down;
    ...
    private int begin_time=-1, end_time=-1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_problem_item_fall_down);
        ...
        tv_problem_item_fall_down = (TextView) findViewById(R.id.tv_problem_item_fall_down);
        ...
        bn_check_history.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final Dialog dialog = new Dialog(Problem_item_fall_down.this);
                ...
                bn_check_to_leave.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.setClass(Problem_item_fall_down.this  , Check_history.class);
        ...
        bn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (has_error == 0) { // no error, can goto next page
                    ...
                    Intent intent = new Intent();
                    intent.setClass(Problem_item_fall_down.this, Record_overview.class);
                    startActivity(intent);
        ...
        public void run(){
            ...
            for (int i = gv.get_now_problem_page()-1; i >=0; i--){
                if (symptom_array[i]==1){
                    ...
                    Intent intent;
                    intent = new Intent();
                    intent.setClass(Problem_item_fall_down.this  , Problem_item_fill_in.class);
                    startActivity(intent);
                    break;
                }
            }
            ...
            if (back_is_none==1){
                Intent intent;
                intent = new Intent();
                intent.setClass(Problem_item_fall_down.this  , Symptom_choose.class);
                startActivity(intent);
            }
